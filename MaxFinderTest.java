...
public class MaxFinderTest {
    ...
    public void givenThreeInteger_ShouldReturnMaxvalue() {
        MaxFinder maxFinder = new MaxFinder(412, 750, -100);
        int max = (int) maxFinder.maximum();
        Assert.assertEquals(750, max);
    }
    ...
    public void givenSixStringinVarargs_ShouldReturnMaxvalue() {
        MaxFinder maxFinder = new MaxFinder();
        String  max = (String) maxFinder.max("tomato","potato","LadyFinger","Garlic","Chilli","Jackfruit");
